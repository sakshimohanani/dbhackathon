    ...
    const aboutSection=[
        {
            ...
            desc:'Discover Your Emotional Wellness'
        },
        {
            id:2,
        ...
        },
        {
            ...
            title:'Books & Community Forum',
            desc:'Empowering Reads for Your Mind'
        }
    ]
  return (
    ...
    <div id="aboutme" className='mt-[50px]'>
        ...
        <div className='w-full bg-pink-300 h-[300px]  justify-center items-center'>
        <div className='flex flex-row justify-between absolute'>
            ...
            <h1 className='w-full px-10 md:px-48 lg:px-80 mt-[50px] text-white'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nesciunt optio incidunt ex porro magni unde ipsa illum voluptatibus asperiores tempore.</h1>
        </div>
        <div className='flex flex-col md:flex-row mt-[-75px] md:px-32 '>
           {
            aboutSection.map((item,index)=>(
                ...
                <div key={index} className="flex  relative w-full items-center justify-center flex-col m-2
                group md:hover:bg-pink-400 rounded-lg py-2">
