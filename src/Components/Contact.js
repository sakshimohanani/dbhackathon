    ...
    <div id="contact" className="flex flex-col justify-center mt-5">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 justify-evenly px-10 md:px-44 mt-5">
        ...
        <div className="w-full">
          ...
          <button className="transition-all ease-in-out hover:scale-110 px-2 text-center bg-blue-500 flex items-center justify-center text-[14px] py-1 mt-2 text-white rounded-md">
            Submit
            <svg
