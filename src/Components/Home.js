  ...
  render() {
    return (
      ...
      <img src={robo} className="w-[70px] ml-5 animate-bounce" alt=''/>
        ...
        <h1 className='text-gray-300 mt-3'>"Embrace the healing power of nature, where tranquility meets resilience, guiding you on a journey to restore and uplift your mental well-being."
</h1>
        <button className='bg-purple-600 p-2 px-3 
